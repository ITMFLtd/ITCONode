...
void rai::mdb_store::initialize (rai::transaction const & transaction_a, rai::genesis const & genesis_a)
{
	...
	account_put (transaction_a, genesis_account, { hash_l, genesis_a.open->hash (), genesis_a.open->hash (), genesis_amount, rai::seconds_since_epoch (), 1, rai::epoch::epoch_0 });
	representation_put (transaction_a, genesis_account, genesis_amount);
